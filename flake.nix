      ...
      (system:
       ...
       in
       {
         defaultPackage = with pkgs; stdenv.mkDerivation {
           ...
           buildInputs = [
             ncurses gnome2.GConf libxml2 gnutls alsa-lib acl gpm gettext jansson harfbuzz.dev
             dbus libselinux systemd
             xlibsWrapper xorg.libXaw Xaw3d xorg.libXpm libpng libjpeg giflib libtiff xorg.libXft
             cairo librsvg imagemagick m17n_lib libotf
